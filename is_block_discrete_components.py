...
IRL_MODEL_PATHS = {
    ...
    'gcl': 'vaso_rl/experiment/irl/gcl_tau0.005_lr0.001_clr0.01_cost_model.pt',
    'iq_learn': 'vaso_rl/experiment/irl/iq_learn_temp0.001_tau0.005_lr0.001_divjs_q_model.pt',
}
